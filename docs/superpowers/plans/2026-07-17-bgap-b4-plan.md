...
Expected: **360 baseline + 20 new = 380 passed** (5 Task 1 + 4 Task 2 + 2 Task 3 = 11 in `test_recommendations.py`; 5 in `test_counterpart_recs.py` → 16 new methods; adjust the report to the exact observed count).
