...
class TestUserFirmsRepo(unittest.TestCase):
    ...
    def test_snoozed_firm_not_prompted(self):
        ...
        uf.mark_prompted(self.uid, self.rb,
                         snooze_until=datetime.datetime(2026, 7, 24,
...
_SESSIONS = [
    {"grade": 4.5, "pts": {"structure": 4, "quant": 2, "communication": 5}},
    {"grade": 4.0, "pts": {"structure": 3, "quant": 0, "communication": 4}},
    {"grade": 4.2, "pts": {"structure": 5, "quant": 1, "communication": 4}},
]
...
Expected first: FAIL (router/service absent). After writing Steps 1–3: PASS (10 tests).
